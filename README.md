...
| <a name="module_traefik"></a> [traefik](#module\_traefik) | git::https://github.com/cloudposse/terraform-aws-ecs-container-definition.git | 0.61.1 |
...
| [aws_iam_role_policy.traefik_ssm](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_ssm_parameter.traefik_basic_auth_users](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) | resource |
...
| <a name="input_basic_auth"></a> [basic\_auth](#input\_basic\_auth) | n/a | <pre>object({<br/>    user              = string<br/>    password          = string<br/>    ignore_auth_paths = optional(list(string), [])<br/>  })</pre> | `null` | no |
